from main_app.service import ReadData
import os
import time
import random
...
def execute():
    ...
    genetic_algorithm(data, PopulationSize, population, objective, NumOfCross, NumLoop)
...
def evaluate(data, PopulationSize, population, objective):
    NumOfTeachers, NumOfLanguages, NumOfProfessionalGroup, NumOfClassCode, NumOfSubjects = data['num_of_teachers'], data['num_of_languages'], data['num_of_groups'], data['num_of_classes'], data['num_of_subjects']
    Teachers = data['teachers']
    LanguageTeacherMapping = data['language_teacher_mapping']
    GroupTeacherMapping = data['group_teacher_mapping']
    Classes = data['classes']
    Subjects = data['subjects']
    Groups = data['group_teachers']
    Languages = data['languages']
    ClassConflict = data['class_conflict']
    objective.clear()
